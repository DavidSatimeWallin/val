/* key.c, Val Emacs, Public Domain, Hugh Barney, 2016, Derived from: Anthony's Editor January 93 */
...
keymap_t keymap[] = {
	...
	{"esc . fzf-find-file     ", "\x1B\x2E", fzf_find_file },
	{"esc - shell-command     ", "\x1B\x2D", shell_cmd },
